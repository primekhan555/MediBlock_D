...
export default class UnVerifiedSummary extends Component {
    constructor(props) {
        super(props);
    }
    state = {
    ...
    componentDidMount() {
        AsyncStorage.getItem('dataSource2', (err, result) => {
            if (result !== null) {
        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{ borderBottomColor: 'black', borderBottomWidth: 1 }}>
                    <Text style={{ alignSelf: 'center', fontWeight: 'bold', fontSize: 17 }}>UnVerified Summary</Text>
                </View>
                <View>
                    {this._renderArr()}
                </View>
